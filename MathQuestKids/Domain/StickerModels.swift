...
struct StickerIcon: Equatable {
    ...
    private static func candyland(_ unit: UnitType) -> StickerIcon {
        switch unit {
        case .kCountObjects:        return StickerIcon(systemName: "cube.fill", gradient: [.pink, .orange])
        case .kComposeDecompose:    return StickerIcon(systemName: "puzzlepiece.fill", gradient: [.red, .pink])
        ...
        case .subtractionStories:   return StickerIcon(systemName: "heart.rectangle.fill", gradient: [.red, .pink])
        case .teenPlaceValue:       return StickerIcon(systemName: "star.square.fill", gradient: [.orange, .pink])
        ...
        case .volumeAndDecimals:    return StickerIcon(systemName: "trophy.fill", gradient: [.yellow, .orange])
        case .kCompareGroups:       return StickerIcon(systemName: "scalemass.fill", gradient: [.pink, .red])
        case .kShapeAttributes:     return StickerIcon(systemName: "triangle.fill", gradient: [.orange, .pink])
        case .g1AddSub100:          return StickerIcon(systemName: "plus.forwardslash.minus", gradient: [.red, .purple])
        case .g1MeasureLength:      return StickerIcon(systemName: "ruler.fill", gradient: [.pink, .orange])
        case .g2PlaceValue1000:     return StickerIcon(systemName: "number.circle.fill", gradient: [.purple, .pink])
        case .g2AddSubRegroup:      return StickerIcon(systemName: "arrow.triangle.swap", gradient: [.orange, .red])
        case .g2EqualGroups:        return StickerIcon(systemName: "square.grid.2x2.fill", gradient: [.pink, .purple])
        case .g2TimeMoney:          return StickerIcon(systemName: "clock.fill", gradient: [.yellow, .pink])
        case .g2DataIntro:          return StickerIcon(systemName: "chart.bar.fill", gradient: [.red, .orange])
        case .g3DivMeaning:         return StickerIcon(systemName: "divide.circle.fill", gradient: [.purple, .red])
        case .g3FractionUnit:       return StickerIcon(systemName: "circle.lefthalf.filled", gradient: [.pink, .purple])
        case .g3FractionCompare:    return StickerIcon(systemName: "lessthan.circle.fill", gradient: [.orange, .purple])
        case .g3AreaConcept:        return StickerIcon(systemName: "square.dashed", gradient: [.red, .pink])
        case .g3MultiStep:          return StickerIcon(systemName: "list.number", gradient: [.purple, .orange])
        case .g4PlaceValueMillion:  return StickerIcon(systemName: "textformat.123", gradient: [.pink, .red])
        case .g4MultMultiDigit:     return StickerIcon(systemName: "multiply.circle.fill", gradient: [.orange, .purple])
        case .g4DivPartialQuotients: return StickerIcon(systemName: "divide.square.fill", gradient: [.red, .pink])
