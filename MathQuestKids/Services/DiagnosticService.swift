...
final class DiagnosticService {
    ...
    private static let questionBank: [DiagnosticQuestion] = [
        ...
        DiagnosticQuestion(id: "diag-k-02", prompt: "Sam has 5 apples and gets 2 more. How many does he have now?", choices: ["6", "7", "8", "9"], correctIndex: 1, targetGrade: .kindergarten, domain: .operations),
        ...
        // Grade 1
        DiagnosticQuestion(id: "diag-g1-01", prompt: "How do you write 14 as tens and ones?", choices: ["1 ten and 4 ones", "4 tens and 1 one", "14 tens", "2 tens and 4 ones"], correctIndex: 0, targetGrade: .grade1, domain: .placeValue),
        DiagnosticQuestion(id: "diag-g1-02", prompt: "12 - 5 = ?", choices: ["6", "7", "8", "9"], correctIndex: 1, targetGrade: .grade1, domain: .operations),
        DiagnosticQuestion(id: "diag-g1-03", prompt: "Which equation matches this story: There are 9 birds, and 3 fly away?", choices: ["9 + 3", "9 - 3", "3 - 9", "9 + 9"], correctIndex: 1, targetGrade: .grade1, domain: .problemSolving),
        ...
        DiagnosticQuestion(id: "diag-g2-03", prompt: "A ribbon is 35 cm long. It is cut into a 20 cm piece and a ? cm piece.", choices: ["10", "15", "20", "25"], correctIndex: 1, targetGrade: .grade2, domain: .measurement),
        ...
        DiagnosticQuestion(id: "diag-g4-02", prompt: "Which decimal is the greatest?", choices: ["0.45", "0.405", "0.54", "0.504"], correctIndex: 2, targetGrade: .grade4, domain: .numberSense),
        ...
        DiagnosticQuestion(id: "diag-g5-02", prompt: "A recipe uses 1.5 cups of sugar per batch. How many cups do you need for 4 batches?", choices: ["5 cups", "5.5 cups", "6 cups", "6.5 cups"], correctIndex: 2, targetGrade: .grade5, domain: .problemSolving),
        DiagnosticQuestion(id: "diag-g5-03", prompt: "What is the volume of a prism that is 4 x 3 x 2?", choices: ["9", "12", "24", "48"], correctIndex: 2, targetGrade: .grade5, domain: .measurement)
    ]
}
